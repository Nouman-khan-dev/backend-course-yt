    ...
    <div>
      ...
      <div className="min-w-screen">
        ...
        <div className="my-4 border-black border-t-2 flex flex-wrap justify-center gap-y-7 gap-x-4">
          {services.map((item) => (
            <article class="min-w-[300px] text-left max-w-[350px] basis[350px] flex-1 hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] dark:shadow-gray-700/25">
              <div class="rounded-[10px] bg-white px-4 !p-8 sm:p-6 dark:bg-gray-900 min-h-full">
                <h3 class="mt-0.5 text-xl font-bold text-gray-900 dark:text-white">
                  {item.service}
                </h3>
                ...
                <div class="mt-4 flex flex-wrap gap-1">
                  <span class="whitespace-nowrap text-xl font-semibold rounded-xl bg-purple-100 px-2.5 py-0.5  text-purple-600">
